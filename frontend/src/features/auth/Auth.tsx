...
const CheckIcon = ({ met }: { met: boolean }) => (
  ...
  >
    <circle
      ...
      r="10"
      strokeWidth="2"
      className={met ? 'met-circle' : 'unmet-circle'}
    />
    <path
      d="M8 12L11 15L16 9"
      strokeWidth="2.5"
      strokeLinecap="round"
      strokeLinejoin="round"
      className={met ? 'met-check' : 'unmet-check'}
    />
  </svg>
);
...
function Auth() {
  ...
  useEffect(() => {
    ...
    if (touched.password) {
      setErrors((prev) => ({
        ...prev,
        password: password.length >= 8 ? undefined : 'Use ao menos 8 caracteres.',
      }));
    }
    ...
    <main className="app">
      <section className="left">
        ...
        <div className="hero">
          ...
          <p>
            A Elite de seus atletas começa por aqui. Aumente a eficiência de sua equipe e melhore a
            gestão de seus alunos com nosso sistema de CRM.
          </p>
        </div>
        ...
        <div className="login-card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className={`expandable-field ${!isSignin ? 'open' : ''}`}>
              <div className="expandable-field-inner">
                <div className="input-group">
                  ...
                  <div
                    className={`input-wrapper has-icon ${errors.name && touched.name ? 'has-error' : ''} ${shakingFields.name ? 'shake-active' : ''}`}
                  >
            ...
            <div className="input-group">
              ...
              <div
                className={`input-wrapper has-icon ${errors.email && touched.email ? 'has-error' : ''} ${shakingFields.email ? 'shake-active' : ''}`}
              >
                <span className="input-icon" aria-hidden="true">
                  <MailIcon />
                </span>
            ...
            <div className="input-group">
              ...
              >
                ...
                <input
                  ...
                  aria-describedby={
                    errors.password && touched.password ? passwordErrorId : undefined
                  }
                />
                <button
                  type="button"
              ...
              <div
                className={`strength-container ${!isSignin && password ? 'visible' : ''}`}
                aria-live="polite"
              >
                  ...
                  <div className="strength-header">
                    ...
                    <div className="strength-bars">
                      <div
                        ...
                        style={{
                          backgroundColor: pwdStrength.score >= 1 ? pwdStrength.color : undefined,
                        }}
                      />
                      <div
                        className={`strength-bar ${pwdStrength.score >= 2 ? 'active' : ''}`}
                        style={{
                          backgroundColor: pwdStrength.score >= 2 ? pwdStrength.color : undefined,
                        }}
                      />
                      <div
                        className={`strength-bar ${pwdStrength.score >= 3 ? 'active' : ''}`}
                        style={{
                          backgroundColor: pwdStrength.score >= 3 ? pwdStrength.color : undefined,
                        }}
                      />
                      <div
                        className={`strength-bar ${pwdStrength.score >= 4 ? 'active' : ''}`}
                        style={{
                          backgroundColor: pwdStrength.score >= 4 ? pwdStrength.color : undefined,
                        }}
                      />
                    </div>
                  </div>
          ...
          <small className="terms">
            Ao continuar, você concorda com nossos <Link to="/terms">Termos</Link> &amp;{' '}
