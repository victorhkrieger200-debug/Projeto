...
function ForgotPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormState('idle');
      setErrors({
        email: error instanceof Error ? error.message : 'Não foi possível enviar o e-mail.',
      });
      triggerShake();
    }
  };
    ...
    <main className="app">
      <section className="left">
        ...
        <div className="hero">
          ...
          <p>
            Não se preocupe. Em poucos passos você estará de volta ao controle da gestão de seus
            alunos e da alta performance de sua equipe.
          </p>
        </div>
          ...
          {!isSuccess ? (
            <>
              ...
              <form onSubmit={handleSubmit} noValidate style={{ marginTop: '1.5rem' }}>
                <div className="input-group">
                  ...
                  <div
                    className={`input-wrapper has-icon ${errors.email && touched.email ? 'has-error' : ''} ${isShaking ? 'shake-active' : ''}`}
                  >
            ...
            <div
              ...
              style={{
                textAlign: 'center',
                padding: '0.5rem 0',
                animation: 'cardEnter 0.4s var(--auth-ease-smooth) both',
              }}
            >
              ...
              <h3 style={{ marginTop: '0.75rem', lineHeight: '1.6', fontSize: '0.9rem' }}>
                Se o e-mail <strong>{email}</strong> estiver em nosso sistema, você receberá um link
                de redefinição em poucos instantes.
              </h3>
              <p
                style={{ fontSize: '0.78rem', color: 'var(--auth-text-light)', marginTop: '1rem' }}
              >
